...
def load_naive_bayes_complement():
        ...
        _service.save_csv_result(validation_predicted, 'nb_complement_results', 'dataset1/results/')
        _service.save_model_to_pkl(classifier, 'nb_complement_results', 'dataset1/models/')
        # _service.hyper_parameter_tuning(ComplementNB(), {'alpha': [0.01, 0.001, 0.1, 1, 10, 100, 1000]}, train_features,
        #                                 train_labels)
...
def parameter_iteration_tunning():
        ...
        for index in _range:
                ...
                print('ComplementNB accuracy ' + str(index) + ' is', accuracy_score(validation_labels, pred))


load_naive_bayes_complement()
