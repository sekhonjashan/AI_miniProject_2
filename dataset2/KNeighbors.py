...
sys.path.extend(["../"])
sys.path.extend(["."])
from dataset2.service import service
...
def load_kneighbors():
        ...
        _service.save_csv_result(validation_predicted, 'k_neighbors_results', 'dataset2/results/')
        _service.save_model_to_pkl(classifier, 'k_neighbors_results', 'dataset2/models/')
