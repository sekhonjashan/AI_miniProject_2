...
def load_naive_bayes_complement():
        ...
        _service.save_csv_result(validation_predicted, 'nb_complement_results', 'dataset2/results/')
        _service.save_model_to_pkl(classifier, 'nb_complement_results', 'dataset2/models/')
